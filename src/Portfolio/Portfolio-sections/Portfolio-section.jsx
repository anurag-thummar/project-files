...
import "./Portfolio-section.css"; // Assuming you have the styles defined in this file
        ...
        <div className="container">
          <div className="portfolio-inner">
            <div className="portfolio-upper">
              ...
              <h2 className="portfolio1 center-text-heading" id="portfolio-heading">
                Our Portfolio
              </h2>
            </div>
            ...
            <div className="portfolio-down">
              <div className="portfolio-down-inner">
                ...
                <div className="portfolio-item all itsolution">
                  ...
                  <div className="portfolio-img" data-height="1600">
                ...
                <div class="portfolio-item all ecommerce">
                  <div class="portfolio-img" data-height="1326">
